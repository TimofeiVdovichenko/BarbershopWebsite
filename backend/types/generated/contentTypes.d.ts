...
export interface ApiKompaniyaKompaniya extends Schema.SingleType {
  collectionName: 'kompaniyas';
  info: {
    singularName: 'kompaniya';
    pluralName: 'kompaniyas';
...
export interface ApiUslugaUsluga extends Schema.CollectionType {
